    ...
    class Simulation
    {
        ...
        private void CreateLandscapeAndAnimals(int InitialWarrenCount, int InitialFoxCount, bool FixedInitialLocations)
        {
            for (int x = 0; x < LandscapeSize; x++)
            {
                for (int y = 0; y < LandscapeSize; y++)
                {
                    Landscape[x, y] = new Location(x, y);
        ...
        private void CreateNewWarren()
        {
            ...
            } while (Landscape[x, y].Warren != null && Landscape[x,y].terrainType != "R");
            if (ShowDetail)
            {
        ...
        private void CreateNewFox()
        {
            ...
            do
            {
                x = Rnd.Next(0, LandscapeSize);
                y = Rnd.Next(0, LandscapeSize);
            } while (Landscape[x, y].Fox != null && Landscape[x, y].terrainType != "R");
            if (ShowDetail)
            {
        ...
        private void FoxesEatRabbitsInWarren(int WarrenX, int WarrenY)
        {
            ...
            for (int FoxX = 0; FoxX < LandscapeSize; FoxX++)
            {
                for (int FoxY = 0; FoxY < LandscapeSize; FoxY++)
                {
                    if (Landscape[FoxX, FoxY].Fox != null)
                    {
                        ...
                        for (int i = NewX; i < TargetX; i++)
                        {
                            if (CheckIfPathCrossesRiver(i, currentY) == true)
                            {
                                Cross = true;
                            }
                            else
                        ...
                        for (int i = NewY; i < TargetY; i++)
                        {
                            if (CheckIfPathCrossesRiver(i, currentX) == true)
                            {
                                Cross = true;
                            }
                            else
            ...
            private void DrawLandscape()
            {
                ...
                for (int y = 0; y < LandscapeSize; y++)
                {
                    ...
                    for (int x = 0; x < LandscapeSize; x++)
                    {
                        ...
                        if (Landscape[x, y].terrainType == "R")
                        {
                            Console.Write("R");
                        }
                        else
            ...
            public bool CheckIfPathCrossesRiver(int x, int y)
            {
                if (Landscape[x, y].terrainType == "R")
                {
                    return true;
        ...
        class Rabbit : Animal
        {
            ...
            public override void CalculateNewAge()
            {
                ...
                if (Age >= 1)
                {
                    if (Gender == Genders.Female)
                    {
                        ProbabilityOfDeathOtherCauses = (0.05 * Age);
                    }
                    else
                    {
                        if (Age == 1)
                        {
                            ProbabilityOfDeathOtherCauses = 0.08;
                        }
                        else if (Age == 2)
                        {
                            ProbabilityOfDeathOtherCauses = 0.11;
                        }
                        else if (Age == 3)
                        {
                            ProbabilityOfDeathOtherCauses = 0.17;
                        }
                        else if (Age == 4)
                        {
                            ProbabilityOfDeathOtherCauses = 0.25;
                        }
                        else if (Age == 5)
                        {
                            ProbabilityOfDeathOtherCauses = 0.38;
                        }
                    }
                }
            }
